...
/**
 * @title MockUSDT0
 * @notice Mock USDT0 token for testing and testnet deployments.
 * @dev USDT0 is the protocol's main settlement collateral. Uses 6 decimals
 *      like the production USDT0 bridge asset on Conflux eSpace.
 */
contract MockUSDT0 is ERC20, Ownable {
    ...
    constructor() ERC20("USDT0", "USDT0") Ownable(msg.sender) {}
