...
describe("Library coverage 3 — CollateralRouterLib", () => {
...
describe("Library coverage 3 — PortfolioRiskLib", () => {
...
describe("Library coverage 3 — RateLimitLib (checkOnly / checkAndUpdateFor)", () => {
...
describe("Library coverage 3 — PositionMath trailing/anchor + helpers", () => {
