...
describe("High Coverage Test Suite", function () {
    ...
    beforeEach(async () => {
        try {
            ...
            const RateLimitLib = await (await ethers.getContractFactory("RateLimitLib")).deploy();
            ...
            const HarnessFactory = await ethers.getContractFactory("CoverageHarness", {
                libraries: {
                    ...
                    "contracts/libraries/RateLimitLib.sol:RateLimitLib": await RateLimitLib.getAddress(),
                    "contracts/libraries/GlobalPnLLib.sol:GlobalPnLLib": await GlobalPnLLib.getAddress(),
            ...
            const MathFactory = await ethers.getContractFactory("MathWrapper");
    ...
    describe("MathWrapper & PositionMath Branches", function () {
