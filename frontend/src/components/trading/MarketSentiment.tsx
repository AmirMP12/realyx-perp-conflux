...
export function MarketSentiment({ longOI, shortOI, symbol }: MarketSentimentProps) {
    ...
    return (
        <div className="glass-panel p-5 flex flex-col gap-6 select-none h-full w-full">
            ...
            <div className="shrink-0 pt-2 border-t border-white/[0.03]">
                <p className="text-[10px] text-text-muted leading-relaxed italic opacity-70">
                    Live OI skew for {symbol}. High skew indicates funding volatility risk.
                </p>
            </div>
        </div>
    );
