            ...
            {t.visible && (
                ...
                >
                    ...
                    <button
                        ...
                        className="text-text-muted hover:text-text-primary transition-colors h-fit p-2 min-h-[32px] min-w-[32px] flex items-center justify-center rounded-lg hover:bg-white/10"
