...
describe("User Route Logic Paths", () => {
    ...
    it("resolves trade market symbols for empty, known, and long addresses", async () => {
    ...
    it("returns 400 for a missing positions address and surfaces indexer errors", async () => {
    ...
    it("returns 400 for a missing trades address and surfaces indexer errors", async () => {
        // empty address
