...
describe('Markets Route Exhaustive Scenarios', () => {
  it('sorts markets by each supported field and direction', async () => {
  ...
  it('filters markets by each category', async () => {
  ...
  it('serves price history from each requested source', async () => {
  ...
  it('computes index price for the markets list', async () => {
